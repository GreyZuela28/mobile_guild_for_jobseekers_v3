...
class JobseekerNotificationPage extends StatefulWidget {
  const JobseekerNotificationPage({super.key});

  @override
  State<JobseekerNotificationPage> createState() =>
      _JobseekerNotificationPageState();
}

class _JobseekerNotificationPageState extends State<JobseekerNotificationPage> {
  @override
