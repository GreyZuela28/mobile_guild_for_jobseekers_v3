...
class EmployerNotificationPage extends StatefulWidget {
  const EmployerNotificationPage({super.key});

  @override
  State<EmployerNotificationPage> createState() =>
      _EmployerNotificationPageState();
}

class _EmployerNotificationPageState extends State<EmployerNotificationPage> {
  @override
